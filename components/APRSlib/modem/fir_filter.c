...
int fir_filter(filter_t *fp, int16_t value) {
    int32_t sum = 0;
...
int16_t *fir_filter_coeff(filter_param_t const *f) {
...
void fir_filter_init(filter_t *fp, int16_t an[], int size) {
    int16_t *p;
